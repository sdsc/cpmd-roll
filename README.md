...
For version 4.3, no intel/mpi/cuda make file is provided and an attempt to make one failed.
It is recommended that for this version, only the gnu compiler should be used.
...
of the cpmd-roll.  To avoid cluttering the cluster frontend with unused
software, the cpmd-roll is configured to install only on compute and
login nodes. To force installation on your frontend, run this command after
adding the cpmd-roll to your distro
